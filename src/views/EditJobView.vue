...
const form=reactive({
  ...
  const handleSubmit= async()=>{
    const updateJob={
        ...
        company:{
            ...
            contactEmail:form.company.contaEmail,
  ...
  onMounted(async () => {
    try {
        ...
        form.company.contaEmail=state.job.company.contactEmail;
        ...
        >
          <form @submit.prevent="handleSubmit">
            ...
            <div class="mb-4">
              ...
              <input
                type="email"
                v-model="form.company.contaEmail"
                name="contact_email"
                class="border rounded w-full py-2 px-3"
                placeholder="Email address for the company"
                required
